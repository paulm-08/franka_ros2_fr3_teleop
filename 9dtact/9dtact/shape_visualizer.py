...
class Visualizer:
    def __init__(self, points):
        ...
        white_shell = open3d.io.read_triangle_mesh(os.path.join(sensor_obj_dir, 'white_shell.obj'))
        black_contact = open3d.io.read_triangle_mesh(os.path.join(sensor_obj_dir, 'black_contact.obj'))
